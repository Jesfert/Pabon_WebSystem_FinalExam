                ...
                <div class="row product-list">
                    <div class="col-12 col-sm-6 col-md-4 product-item">
                        <div class="product-container">
                            <div class="row">
                                <div class="col-md-12"><a class="product-image" href="#"><img src="assets/image/store/datenight/d1.jpg"></a></div>
                            </div>
                            <div class="row">
                                <div class="col-8">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 product-item">
                        <div class="product-container">
                            <div class="row">
                                <div class="col-md-12"><a class="product-image" href="#"><img src="assets/image/store/datenight/d2.jpg"></a></div>
                            </div>
                            <div class="row">
                                <div class="col-8">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 product-item">
                        <div class="product-container">
                            <div class="row">
                                <div class="col-md-12"><a class="product-image" href="#"><img src="assets/image/store/datenight/d3.jpg"></a></div>
                            </div>
                            <div class="row">
                                <div class="col-8">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 product-item">
                        <div class="product-container">
                            <div class="row">
                                <div class="col-md-12"><a class="product-image" href="#"><img src="assets/image/store/datenight/d4.jpg"></a></div>
                            </div>
                            <div class="row">
                                <div class="col-8">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 product-item">
                        <div class="product-container">
                            <div class="row">
                                <div class="col-md-12"><a class="product-image" href="#"><img src="assets/image/store/datenight/d5.jpg"></a></div>
                            </div>
                            <div class="row">
                                <div class="col-8">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 product-item">
                        <div class="product-container">
                            <div class="row">
                                <div class="col-md-12"><a class="product-image" href="#"><img src="assets/image/store/datenight/d6.jpg"></a></div>
                            </div>
                            <div class="row">
                                <div class="col-8">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 product-item">
                        <div class="product-container">
                            <div class="row">
                                <div class="col-md-12"><a class="product-image" href="#"><img src="assets/image/store/datenight/d7.png"></a></div>
                            </div>
                            <div class="row">
                                <div class="col-8">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 product-item">
                        <div class="product-container">
                            <div class="row">
                                <div class="col-md-12"><a class="product-image" href="#"><img src="assets/image/store/datenight/d8.jpg"></a></div>
                            </div>
                            <div class="row">
                                <div class="col-8">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 product-item">
                        <div class="product-container">
                            <div class="row">
                                <div class="col-md-12"><a class="product-image" href="#"><img src="assets/image/store/datenight/d9.jpg"></a></div>
                            </div>
                            <div class="row">
                                <div class="col-8">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 product-item">
                        <div class="product-container">
                            <div class="row">
                                <div class="col-md-12"><a class="product-image" href="#"><img src="assets/image/store/datenight/d10.jpg"></a></div>
                            </div>
                            <div class="row">
                                <div class="col-8">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 product-item">
                        <div class="product-container">
                            <div class="row">
                                <div class="col-md-12"><a class="product-image" href="#"><img src="assets/image/store/datenight/d11.jpg"></a></div>
                            </div>
                            <div class="row">
                                <div class="col-8">
                                    <h2><a href="#">Product 11</a></h2>
                                </div>
                            </div>
                            <div class="pb-2 product-rating">
                                <i class="fa fa-star"></i>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-6"><button class="btn btn-light" type="button" onclick="showProductDetails('Product 11', '' ,'P599.00')">Buy Now!</button></div>
                                        <div class="col-6">
                                            <p class="product-price">P599.00 </p>
                                        </div>
                                    </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 product-item">
                        <div class="product-container">
                            <div class="row">
                                <div class="col-md-12"><a class="product-image" href="#"><img src="assets/image/store/datenight/d12.jpg"></a></div>
                            </div>
                            <div class="row">
                                <div class="col-8">
                                    <h2><a href="#">Product 12</a></h2>
                                </div>
                            </div>
                            <div class="pb-2 product-rating">
                                <i class="fa fa-star"></i>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-6"><button class="btn btn-light" type="button" onclick="showProductDetails('Product 12', '' ,'P599.00')">Buy Now!</button></div>
                                        <div class="col-6">
                                            <p class="product-price">P599.00 </p>
                                        </div>
                                    </div>
