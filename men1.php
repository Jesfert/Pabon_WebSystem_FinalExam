            ...
            <div class="row card-container">
              <div class="col-12 col-sm-3 col-md-4 card card_category">
                <a href="business_casual.php">
                  ...
                  <div class="content">
                    <div class="card-category">CASUALS</div>
                    <h3 class="card-heading">Business Casual</h3>
                  </div>
                </a>
              </div>
              <div class="col-12 col-sm-3 col-md-4 card card_category">
              ...
              <div class="col-12 col-sm-3 col-md-4 card card_category">
                <a href="cream_polo.php">
                  ...
                  <div class="content">
                    <div class="card-category">FORMAL</div>
              ...
              <div class="col-12 col-sm-3 col-md-4 card card_category">
                  <a href="summer_outfit.php">
                    ...
                    <div class="content">
                      <div class="card-category">Summer</div>
                      <h3 class="card-heading">Summer Outfits</h3>
                    </div>
                  </a>
                </div>
              <div class="col-12 col-sm-3 col-md-4 card card_category">
                <a href="casual_date.php">
                  ...
                  <div class="content">
                    ...
                    <h3 class="card-heading">Casual Date Night</h3>
                  </div>
                </a>
              </div>
              <div class="col-12 col-sm-3 col-md-4 card card_category">
                <a href="vintage.php">
                  ...
                  <div class="content">
                    <div class="card-category">Vintage</div>
                    <h3 class="card-heading">Vintage Outfit</h3>
                  </div>
                </a> 
              </div>
            </div>
